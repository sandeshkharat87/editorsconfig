...
global new_segments_for_classifications
...
class Client:
    ...
    #             # if seg["text"] not in unique_text:
    #             #     unique_text.add(seg["text"]) 

    #             # with open("yo-niggs.txt", "a") as _f:
    #             #     _f.write(" ".join(text))
    #             # ### cstm --end--
...
class TranscriptionClient(TranscriptionTeeClient):
    ...
    """
    def __init__(
        self,host,port,lang=None,translate=False,model="small",
        use_vad=True,save_output_recording=False,output_recording_filename="./output_recording.wav",output_transcription_path="./output.srt",
        log_transcription=True,max_clients=4,max_connection_time=600):
